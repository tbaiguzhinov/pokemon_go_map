...
class Pokemon(models.Model):
    ...
    image = models.ImageField("изображение", upload_to="pokemon_images", default=None, blank=True)
...
class PokemonEntity(models.Model):
    ...
    level = models.IntegerField("уровень", null=True, default=None, blank=True)
    health = models.IntegerField("здоровье", null=True, default=None, blank=True)
    strength = models.IntegerField("сила", null=True, default=None, blank=True)
    defence = models.IntegerField("защита", null=True, default=None, blank=True)
    stamina = models.IntegerField("выносливость", null=True, default=None, blank=True)
